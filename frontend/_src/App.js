...
import { UserContext } from './context/UserContext.js'; // User context for login state
import Header from './components/Header';
import HeroSection from './components/HeroSection';
import SearchBar from './components/SearchBar';
import PublicListings from './components/PublicListings';
import Footer from './components/Footer';
import UserDashboard from './components/UserDashboard'; // Only displayed after login
...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <HeroSection />
      <SearchBar />
      {isLoggedIn ? <UserDashboard /> : <PublicListings />}
      <Footer />
